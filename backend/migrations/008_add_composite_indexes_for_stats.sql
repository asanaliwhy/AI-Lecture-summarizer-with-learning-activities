...
CREATE INDEX IF NOT EXISTS idx_summaries_user_last_accessed_at
ON summaries(user_id, last_accessed_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_quizzes_user_last_accessed_at
ON quizzes(user_id, last_accessed_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_flashcard_decks_user_last_accessed_at
ON flashcard_decks(user_id, last_accessed_at DESC);
